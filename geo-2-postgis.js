...
mkdirp("shp", function (err) {
    ...
    if (err) {
        ...
        makerequest("https://s3-us-west-1.amazonaws.com/acs2015geo/", "carto_bg_15.zip"); // bg CARTO
        makerequest("https://s3-us-west-1.amazonaws.com/acs2015geo/", "carto_pl_15.zip"); // pl CARTO
        makerequest("https://s3-us-west-1.amazonaws.com/acs2015geo/", "carto_tr_15.zip"); // tr CARTO
        ...
        makerequest("https://s3-us-west-1.amazonaws.com/acs2015geo/", "tiger_bg_15.zip"); // bg TIGER
        makerequest("https://s3-us-west-1.amazonaws.com/acs2015geo/", "tiger_pl_15.zip"); // pl TIGER
        makerequest("https://s3-us-west-1.amazonaws.com/acs2015geo/", "tiger_tr_15.zip"); // tr TIGER
